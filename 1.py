...
some_student = Student('Gordon', 'Freeman', 'nailer')
steep_student = Student('Дмитрий', 'Иванович', 'он')
some_student.courses_in_progress += ['Python']
some_student.finished_courses += ['Введение в программирование']
steep_student.courses_in_progress += ['Python']
steep_student.finished_courses += ['Введение в программирование', 'Git']

some_lecturer = Lecturer('Some1', 'Flatcher1')
steep_lecturer = Lecturer('Steep1', 'Davis1')
some_lecturer.courses_attached += ['Python']
steep_lecturer.courses_attached += ['Python', 'Git']

some_reviewer = Reviewer('Some2', 'Flatcher2')
steep_reviewer = Reviewer('Steep2', 'Davis2')
